...
CREATE TABLE `dataruns` (
  ...
  `metric` enum('cv_judgement_metric','test_judgment_metric') DEFAULT NULL,
...
CREATE TABLE `learners` (
  ...
  `cv_accuracies64` longtext,
  `cv_cohen_kappas64` longtext,
  ...
  `cv_mu_sigmas64` longtext,
  `test_accuracies64` longtext,
  `test_cohen_kappas64` longtext,
